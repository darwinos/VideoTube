    ...
    class VideoProcessor {
        ...
        public function generateThumbnails($filePath) {
            ...
            for($num = 1; $num <= $numThumbnails; $num++) {
                ...
                $fullThumbnalPath = "$pathToThumbnail/$videoId-$imageName";

                $cmd = "$this->ffmpegPath -i $filePath -ss $interval -s $thumbnailSize -vframes 1 $fullThumbnalPath 2>&1";
                ...
                $query->bindParam(":filePath", $fullThumbnalPath);
